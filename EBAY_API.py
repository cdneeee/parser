...
#product finding
productRequest = input('Enter a product: ')
productRequest = productRequest.lower()

#setting a string to the response sent from the api
...
if search == -1:
  ...
  poundPos = title.lower().find('pounds')
  ...
  #print(title[min(existingNumberPositions): max(existingNumberPositions)+1])
  #print(existingNumberPositions)
  
  #weightNumber = float(title[min(existingNumberPositions): max(existingNumberPositions)+1])
  ...
  try:
    ...
    if canPos == -1:
      ...
      match unitInUse: 
        ...
        case 2 :
          weightNumber = 0.453592 * weightNumber
          pricePerKG = totalCost / weightNumber
          print('The price per Kg is: $' + str(round(pricePerKG, 2)))
        case 3:
          weightNumber = 0.0283495 * weightNumber
          pricePerKG = totalCost / weightNumber
          print('The price per Kg is: $' + str(round(pricePerKG, 2)))
        case 4:
          weightNumber = 0.453592 * weightNumber
        ...
        case 6: 
          ...
          pricePerKG = totalCost / weightNumber
          print('The price per Kg is: $' + str(round(pricePerKG, 2)))
    #if theres is a mention of can, the weight reading system doesn't work
    else: 
      print('weight could not be read')
        
  
 
  '''print(unitInUse); print(weightNumber)
  print(title.find(str(5)))
